...
public abstract class Healers extends BasicCharacter {
    ...
    public Healers(Coordinates position, char squadSymbol, int attack, int defence, int[] damage, double maxHealth, int speed, Squad allies, Squad enemies, int amount) {
        super(position, squadSymbol, attack, defence, damage, maxHealth, speed, allies, enemies, amount);
    }
