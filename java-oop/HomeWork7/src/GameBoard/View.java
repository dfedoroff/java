...
public class View {
    ...
    public void view() {
        ...
        System.out.println(Constants.AnsiColors.ANSI_RED + "Ход: " + step++ + Constants.AnsiColors.ANSI_RESET);
        ...
        for (int i = 0; i < Constants.BOARD_SIZE; i++) {
            for (int j = 0; j < Constants.BOARD_SIZE; j++) {
                ...
                if (character == null) {
                    ...
                    System.out.print("| " + character.getSquadColor() + character.getCharacterSymbol() + " " + Constants.AnsiColors.ANSI_RESET);
                }
            }
            ...
            while (!characterInRow.isEmpty()) {
                ...
                System.out.print(character.getSquadColor() + String.format("%-9s", playerName));
                System.out.print("x" + String.format("%-5d", character.getAmount()));
                System.out.print("номер=" + String.format("%-3d", character.getId()));
                System.out.print("здоровье=" + String.format("%4.1f/%-4.1f    ", character.getHealth(), character.getMaxHealth()) + Constants.AnsiColors.ANSI_RESET);
            }
            System.out.println();
